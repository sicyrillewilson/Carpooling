...
class Trajet3Adapter (private val trajets: List<Trajet>, private val onTrajetClicked: (Trajet) -> Unit) : RecyclerView.Adapter<Trajet3Adapter.TicketViewHolder>() {

    // ViewHolder inner class
    class TicketViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val destinationTextView: TextView = itemView.findViewById(R.id.itm_trajet3_destination)
        val lieuDepartTextView: TextView = itemView.findViewById(R.id.itm_trajet3_lieu_de_depart)
        val heureDepartTextView: TextView = itemView.findViewById(R.id.itm_trajet3_heure_de_depart)
        val prixTextView: TextView = itemView.findViewById(R.id.itm_trajet3_prix)
        val profileImageView: CircleImageView = itemView.findViewById(R.id.itm_trajet3_conducteur_profil)
        // LinearLayout pour les étoiles
        val starContainer: LinearLayout = itemView.findViewById(R.id.itm_trajet3_starContainer)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TicketViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_trajet3, parent, false)
