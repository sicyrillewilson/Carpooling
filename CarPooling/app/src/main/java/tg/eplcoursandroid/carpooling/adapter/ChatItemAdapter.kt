...
class ChatItemAdapter (private val trajets: List<Trajet>) : RecyclerView.Adapter<ChatItemAdapter.TicketViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TicketViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_list_chat, parent, false)
