...
class Trajet1Adapter (private val trajets: List<Trajet>) : RecyclerView.Adapter<Trajet1Adapter.TicketViewHolder>() {
    ...
    class TicketViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val destinationTextView: TextView = itemView.findViewById(R.id.itm_trajet1_destination)
        val lieuDepartTextView: TextView = itemView.findViewById(R.id.itm_trajet1_lieu_de_depart)
        val heureDepartTextView: TextView = itemView.findViewById(R.id.itm_trajet1_heure_de_depart)
        val prixTextView: TextView = itemView.findViewById(R.id.itm_trajet1_prix)
        val profileImageView: CircleImageView = itemView.findViewById(R.id.itm_trajet1_conducteur_profil)
        // LinearLayout pour les étoiles
        val starContainer: LinearLayout = itemView.findViewById(R.id.itm_trajet1_starContainer)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TicketViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_trajet1, parent, false)
