...
class Trajet2Adapter (private var trajets: MutableList<Trajet>, private val onTrajetClicked: (Trajet) -> Unit) : RecyclerView.Adapter<Trajet2Adapter.TicketViewHolder>() {
