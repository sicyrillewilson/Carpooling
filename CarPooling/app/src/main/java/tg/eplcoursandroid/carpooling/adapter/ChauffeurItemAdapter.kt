...
class ChauffeurItemAdapter (private val trajets: List<Trajet>) : RecyclerView.Adapter<ChauffeurItemAdapter.TicketViewHolder>() {

    // ViewHolder inner class
    class TicketViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val destinationTextView: TextView = itemView.findViewById(R.id.itm_chauffeur_destination)
        val lieuDepartTextView: TextView = itemView.findViewById(R.id.itm_chauffeur_lieu_de_depart)
        val heureDepartTextView: TextView = itemView.findViewById(R.id.itm_chauffeur_heure_de_depart)
        val prixTextView: TextView = itemView.findViewById(R.id.itm_chauffeur_prix)
        val profileImageView: CircleImageView = itemView.findViewById(R.id.itm_chauffeur_conducteur_profil)
        // LinearLayout pour les étoiles
        val starContainer: LinearLayout = itemView.findViewById(R.id.itm_chauffeur_starContainer)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TicketViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_chauffeur, parent, false)
